...
# NOTE: Model selection is limited to those supporting tool_config with converse_stream,
# which is required for the swarm multi-agent pattern implementation.
